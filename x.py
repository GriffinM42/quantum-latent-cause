...
# print(get_noisy_control(1, x))
# print(np.trace(get_noisy_control(1, x)))

print(get_dephase_control(1, x))
print(np.trace(get_dephase_control(1, x)))

dx = 2
dy = 2
dz = 2

problem = qci.QProblem(get_dephase_control(1, x), dx, dy, dz)
